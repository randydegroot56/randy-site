...
def test_write_spec_only_plan_module_path_none(tmp_path, writer):
    """Writer handles spec-only plans where module_path is None."""
    output = tmp_path / "tests" / "test_myspec.py"
    scenario = TestScenario(
    ...
    assert "Generated by TestGeneratorAgent" in content
    assert "from-spec spec_20260415_001" in content
